...
def test_volume_bucket_row_consistent_across_excel_markdown_html_view_model_and_rendered_html(tmp_path: Path):
    ...
    assert xlsx_row["median_improvement_pct"] == pytest.approx(core_row["median_improvement_pct"])
    ...
    assert md_row["Mediana mejora"] == _fmt_signed_pct_scaled(core_row["median_improvement_pct"])
